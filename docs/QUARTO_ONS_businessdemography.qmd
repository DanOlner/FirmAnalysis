...
* **High growth firms in South Yorkshire and nationally (10+ employees and 20%+ employee growth av per year over 3 years):**
    ...
    + South Yorkshire (and Sheffield, Barnley, Doncaster + Rotherham separately) have remained at or near the bottom for proportion of high growth firms, with Rotherham in particular dropping over time. (See @fig-highgrowth-raw, @fig-highgrowth-percentoffirms10plus, @fig-highgrowth-percentoffirms10plus-cores - **hover for preview** or see below.)
...
* Code is [here](https://github.com/DanOlner/FirmAnalysis/blob/master/ONS_business_demography.R), quarto code for this report is [here]().
